...
# Description: 
  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel(1)) {
      logaccess($_SESSION['uid'], $package, "Deleting " . $formVars['id'] . " from userstories");
      ...
      print "alert('User Story deleted.');\n";
