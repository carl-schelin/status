...
// Add slashes to the username and md5() the password 
      ...
      $q_st_users = mysqli_query($db, $q_string);

// Check that at least one row was returned 
      $c_st_users = mysqli_num_rows($q_st_users); 
...
//session_register('username'); // session_register() has been depreciated in PHP5
          ...
          $_SESSION['email']       = $a_st_users['usr_email'];
...
<p>Log in to the Status App or select an option below.</p>

<center>

<input title="Create a new account in Status" type="submit" onclick="location.href='<?php print $Loginroot; ?>/sign_up.php';" value="Create Account" name="register">&nbsp;&nbsp;&nbsp;&nbsp;
...
<?php
  if ("inwork" == "completed") {
?>
<input title="E-Mail a link to your registered email address to auto-login to the Status" disabled="yes" type="submit" onclick="location.href='<?php print $Loginroot; ?>/magic.php';" value="Magic Link" name="magic">
<?php
  }
?>
